import 'dart:convert';
import 'package:coffee_shop/screens/about.dart';
...
import 'package:coffee_shop/screens/productitem.dart';
...
class _DashboardScreenState extends State<DashboardScreen> {
 ...
 Future<List<Product>> fetchProducts() async {
    final response = await http.get(Uri.parse("http://www.nattiee.com/coffee/getproducts.php"));
    if (response.statusCode == 200) {
      final jsonData = json.decode(response.body);
      final List<Product> products = (jsonData['products'] as List).map((productJson) => Product.fromJson(productJson)).toList();
      return products;
    } else {
                        ...
                        return GridView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return GestureDetector(
                              ...
                              child: ProductItem(product: snapshot.data![index], onAddToCart: _addToCart),
                            );
                          },
                        );
                      }
